package cn.byk.pandora.libs.base.widget.indicator;
...
import cn.byk.pandora.libs.base.widget.indicator.anim.AnimationType;
import cn.byk.pandora.libs.base.widget.indicator.anim.BaseAnimation;
import cn.byk.pandora.libs.base.widget.indicator.anim.ScaleAnimation;
import cn.byk.pandora.libs.base.widget.indicator.anim.ValueAnimation;
...
public class PageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public void setProgress(int selectingPosition, float progress) {
        if (interactiveAnimation) {
            ...
            BaseAnimation animator = getSelectedAnimation();
    ...
    @Nullable
    private BaseAnimation getSelectedAnimation() {
        switch (animationType) {
            case COLOR:
