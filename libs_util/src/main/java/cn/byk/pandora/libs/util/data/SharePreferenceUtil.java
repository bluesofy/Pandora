package cn.byk.pandora.libs.util.data;
...
public class SharePreferenceUtil {
    ...
    private static Map<String, SharePreferenceUtil> sPreferences = new HashMap<>();
    // Migrate Map
    ...
    private WeakHashMap<String, HashSet<IOnSharedChangeListener>> listenersMap
            = new WeakHashMap<>();
    ...
    public synchronized SharePreferenceUtil getInstance(Context context, String prefName) {
